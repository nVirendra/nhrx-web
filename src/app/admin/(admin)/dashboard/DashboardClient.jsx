              ...
              <PieChart>
                ...
                >
                  {departmentData.map((item, idx) => (
                    <Cell key={idx} fill={`var(--color-${item.key})`} />
                  ))}
                </Pie>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            {recentActivities.map((activity, index) => (
              <div
                key={index}
                className="flex items-start gap-3 p-4 rounded-xl hover:bg-muted/50 cursor-pointer transition-all duration-200"
              >
                <div
            ...
            <CarouselContent>
              {announcements.map((note, index) => (
                <CarouselItem key={index}>
                  <div className="p-6 rounded-xl bg-secondary/40 hover:bg-secondary transition-all duration-200">
                    {note}
                  </div>
                </CarouselItem>
              ))}
